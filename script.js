...
const WEBHOOK_URL = 'https://discord.com/api/webhooks/1379121779871715419/KWFgmqUN3uK9-hV3ftWu4qIv3YnV-KL1Y9PmDnOg7BS1agVQdUGMq4RczuPwr_K1jFLh';
...
document.getElementById('messageForm').addEventListener('submit', async (e) => {
    ...
    const embed = {
        title: "DEV → LORD رسالة جديدة من الموقع",
        color: 5814783,
        fields: [
